package com.johnfrancis.samplearch.logger;
...
public final class Log {
  ...
  /**
   * A view into Timber's planted trees as a tree itself. This can be used for injecting a com.billion.androidbasetemplate.logger
